...
class Coches: 
    ...
    def __init__(self,color,marca,modelo,velocidad,caballaje,plazas):
        ...
        self.plazas=plazas
    # El encapsulamiento o visibildad es importante que a través de el es
...
class caminones(Coches):
  ...
  def setEje(self,capacidadCarga):
   self.__capacidadCarga=capacidadCarga

   def getInfo(self):
      print(f"Marca: {self.getMarca()} {self.getColor}, numero de plazas{self.getPlazas}\n Modelo:")
